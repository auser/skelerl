...
Gem::Specification.new do |s|
  ...
  s.date = %q{2009-02-06}
  s.description = %q{This skeleton app takes care of everything you'd need in an erlang application, but don't want to do yourself... Check out the README for more!  Fri Feb 06 16:53:54 -0800 2009}
  ...
  s.summary = %q{This skeleton app takes care of everything you'd need in an erlang application, but don't want to do yourself... Check out the README for more!  Fri Feb 06 16:53:54 -0800 2009}
