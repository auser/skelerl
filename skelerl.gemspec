...
Gem::Specification.new do |s|
  ...
  s.date = %q{2009-02-07}
  s.description = %q{This skeleton app takes care of everything you'd need in an erlang application, but don't want to do yourself... Check out the README for more!   Sat Feb 07 18:19:31 -0800 2009}
  ...
  s.summary = %q{This skeleton app takes care of everything you'd need in an erlang application, but don't want to do yourself... Check out the README for more!   Sat Feb 07 18:19:31 -0800 2009}
